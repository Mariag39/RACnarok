...
.method constructor <init>(Lcom/android/billingclient/api/BillingClientImpl;ILcom/android/billingclient/api/SkuDetails;Ljava/lang/String;Lcom/android/billingclient/api/BillingFlowParams;Landroid/os/Bundle;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/android/billingclient/api/zzz;->zzf:Lcom/android/billingclient/api/BillingClientImpl;

    iput p2, p0, Lcom/android/billingclient/api/zzz;->zza:I
    ...
    iput-object p5, p0, Lcom/android/billingclient/api/zzz;->zzd:Lcom/android/billingclient/api/BillingFlowParams;

    iput-object p6, p0, Lcom/android/billingclient/api/zzz;->zze:Landroid/os/Bundle;
...
.method public final synthetic call()Ljava/lang/Object;
    ...
    .line 3
    iget-object v0, p0, Lcom/android/billingclient/api/zzz;->zzf:Lcom/android/billingclient/api/BillingClientImpl;

    invoke-static {v0}, Lcom/android/billingclient/api/BillingClientImpl;->zzb(Lcom/android/billingclient/api/BillingClientImpl;)Lcom/google/android/gms/internal/play_billing/zzc;

    move-result-object v1

    iget v2, p0, Lcom/android/billingclient/api/zzz;->zza:I

    iget-object v0, p0, Lcom/android/billingclient/api/zzz;->zzf:Lcom/android/billingclient/api/BillingClientImpl;

    .line 4
    invoke-static {v0}, Lcom/android/billingclient/api/BillingClientImpl;->zza(Lcom/android/billingclient/api/BillingClientImpl;)Landroid/content/Context;
    ...
    iget-object v5, p0, Lcom/android/billingclient/api/zzz;->zzc:Ljava/lang/String;

    iget-object v0, p0, Lcom/android/billingclient/api/zzz;->zzd:Lcom/android/billingclient/api/BillingFlowParams;

    .line 8
    iget-object v7, p0, Lcom/android/billingclient/api/zzz;->zze:Landroid/os/Bundle;
